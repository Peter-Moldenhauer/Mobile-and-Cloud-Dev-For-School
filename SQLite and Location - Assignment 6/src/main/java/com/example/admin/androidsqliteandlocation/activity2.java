package com.example.admin.androidsqliteandlocation;
...
public class activity2 extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private LocationRequest getmLocationRequest;
    ...
    private void populateTable(){
        if(mSQLDB != null) {
            try {
                ...
                ListView SQLListView = (ListView) findViewById(R.id.sql_list_display);
